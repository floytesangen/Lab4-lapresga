...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2011, 9, 9), new DateTime(2011, 9, 11), 50);
            var remainingFlight = new Flight(new DateTime(2011, 9, 13), new DateTime(2011, 9, 19), 100);
